...
set(ALL_RVSTORE_SUPPORTED_ARCH ${X86} ${X86_64} ${ARM64})
...
if(APPLE)
  ...
  list_intersect(RVSTORE_SUPPORTED_ARCH
    ALL_RVSTORE_SUPPORTED_ARCH
  ...
  filter_available_targets(UBSAN_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  filter_available_targets(RVSTORE_SUPPORTED_ARCH ${ALL_RVSTORE_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS rvstore;asan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND RVSTORE_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux|Darwin")
  set(COMPILER_RT_HAS_RVSTORE TRUE)
else()
  set(COMPILER_RT_HAS_RVSTORE FALSE)
endif()
